...
function mensajePantallaNuevosSkills(){
    ...
    $("#botonSkillFinal").on("click", function(){
        $("#botonSkillFinal").fadeOut("slow",function(){
...
function habilitarBotones(){
    ...
    //TODO : Agregar mochila
}
function deshabilitarBotones(){ //!N
...
function tiposDeEnemigo(nombre,descripcion){
    this.nombre = nombre;
    this.descripcion = descripcion;
}
function tiposDeMontura(nombre,descripcion){
    this.nombre = nombre;
    this.descripcion = descripcion;
}
const enemigos = []
...
function perderCombate(){
    $(".texto").fadeIn("slow",function(){})
    $(".texto").unbind("click")
    $(".texto").text("Perdiste el combate. Has derrotado a " +  enemigosPeleados + " enemigos.")
}